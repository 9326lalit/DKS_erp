...
export function LandingNavbar() {
  ...
  return (
    <>
      {/* ── Desktop header ─────────────────────────────────────────────────── */}
      <header
        className={`sticky top-0 z-40 border-b border-slate-200/80 bg-white/95 backdrop-blur-md transition-shadow ${scrolled ? "shadow-[0_4px_24px_-8px_rgba(15,23,42,0.12)]" : ""
          }`}
      >
              ...
              return (
                ...
                >
                  {item.href && !hasDropdown ? (
                    ...
                    <button
                      className={`flex items-center gap-1 rounded-xl px-3.5 py-2.5 text-sm font-medium transition ${isActive
